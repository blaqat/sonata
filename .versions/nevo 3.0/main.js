...
// This code snippet listens for messages from a client. If the message is not from a bot and is not in test mode, it sets up the client's nickname. It then creates a message interpreter and executes the result if there is one.
