...
var Playlists = /** @class */ (function () {
    function Playlists(api) {
        ...
        this.getV2 = function (playlistResolvable) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.resolve.getAlt(playlistResolvable)];
                    case 1:
                        playlistID = _a.sent();
                        return [4 /*yield*/, this.api.getV2("/playlists/soundcloud:playlists:" + playlistID)];
                    case 2:
                        response = _a.sent();
                        return [2 /*return*/, response];
                }
