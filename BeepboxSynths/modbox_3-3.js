...
(function (beepbox) {
    ...
    class ExportPrompt {
        ...
        exportToWav(peorotierw) {
            const synth = new beepbox.Synth(peorotierw || this._doc.song);
...
(function (beepbox) {
    ...
    const isMobile = false///Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini|android|ipad|playbook|silk/i.test(navigator.userAgent);
