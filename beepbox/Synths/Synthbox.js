...
const exportToWav = async function(thelink) {
    ...
    const sampleFrames = synth.getTotalSamples(true, true, synth.loopRepeatCount);
...
Config.maxChordSize = 8;
Config.operatorCount = 6;
Config.algorithms = toNameMap([
    { name: "1â†2â†3â†4â†5â†6", carrierCount: 1, associatedCarrier: [1, 1, 1, 1, 1, 1], modulatedBy: [[2], [3], [4], [5], [6], []] },
    { name: "1â†3â€ƒ2â†4â†5â†6", carrierCount: 2, associatedCarrier: [1, 2, 2, 2, 2, 2], modulatedBy: [[3], [4], [], [5], [6], []] },
    { name: "1â†3â†4â€ƒ2â†5â†6", carrierCount: 2, associatedCarrier: [1, 1, 1, 2, 2, 2], modulatedBy: [[3], [5], [4], [], [6], []] },
    { name: "1â†4â€ƒ2â†5â€ƒ3â†6", carrierCount: 3, associatedCarrier: [1, 2, 3, 1, 2, 3], modulatedBy: [[4], [5], [6], [], [], []] },
    { name: "1â†3â€‚2â†(4â€‚5â†6)", carrierCount: 2, associatedCarrier: [1, 2, 2, 2, 2, 2], modulatedBy: [[3], [4, 5], [], [], [6], []] },
    { name: "1â†(3â€‚4)â€‚2â†5â†6", carrierCount: 2, associatedCarrier: [1, 2, 2, 2, 2, 2], modulatedBy: [[3, 4], [5], [], [], [6], []] },
    { name: "1â†3â€ƒ2â†(4â€ƒ5â€ƒ6)", carrierCount: 2, associatedCarrier: [1, 2, 2, 2, 2, 2], modulatedBy: [[3], [4, 5, 6], [], [], [], []] },
    { name: "1â†3â€‚2â†(4â€‚5)â†6", carrierCount: 2, associatedCarrier: [1, 2, 2, 2, 2, 2], modulatedBy: [[3], [4, 5], [], [6], [6], []] },
    { name: "1â†3â€ƒ2â†4â†(5â€ƒ6)", carrierCount: 2, associatedCarrier: [1, 2, 2, 2, 2, 2], modulatedBy: [[3], [4], [], [5, 6], [], []] },
    { name: "1â†(2â€ƒ3â€ƒ4â€ƒ5â€ƒ6)", carrierCount: 1, associatedCarrier: [1, 1, 1, 1, 1, 1], modulatedBy: [[2, 3, 4, 5, 6], [], [], [], [], []] },
    { name: "1â†(2â€ƒ3â†5â€ƒ4â†6)", carrierCount: 1, associatedCarrier: [1, 1, 1, 1, 1, 1], modulatedBy: [[2, 3, 4], [], [5], [6], [], []] },
    { name: "1â†(2â€ƒ3â€ƒ4â†5â†6)", carrierCount: 1, associatedCarrier: [1, 1, 1, 1, 1, 1], modulatedBy: [[2, 3, 4], [], [], [5], [6], []] },
    { name: "1â†4â†5â€ƒ(2â€ƒ3)â†6", carrierCount: 3, associatedCarrier: [1, 2, 3, 1, 2, 3], modulatedBy: [[4], [6], [6], [5], [], []] },
    { name: "1â†(3â€ƒ4)â†5 2â†6", carrierCount: 2, associatedCarrier: [1, 2, 2, 2, 2, 2], modulatedBy: [[3, 4], [6], [5], [5], [], []] },
    { name: "(1â€ƒ2)â†4â€ƒ3â†(5â€ƒ6)", carrierCount: 3, associatedCarrier: [1, 2, 3, 1, 2, 3], modulatedBy: [[4], [4], [5, 6], [], [], []] },
    { name: "(1â€ƒ2)â†5â€ƒ(3â€ƒ4)â†6", carrierCount: 3, associatedCarrier: [1, 2, 3, 4, 4, 4], modulatedBy: [[5], [5], [6], [6], [], []] },
    { name: "(1â€ƒ2â€ƒ3)â†(4â€ƒ5â€ƒ6)", carrierCount: 3, associatedCarrier: [1, 2, 3, 1, 2, 3], modulatedBy: [[4, 5, 6], [4, 5, 6], [4, 5, 6], [], [], []] },
    { name: "1â†5â€ƒ(2â€ƒ3â€ƒ4)â†6", carrierCount: 4, associatedCarrier: [1, 2, 3, 4, 4, 4], modulatedBy: [[5], [6], [6], [6], [], []] },
    { name: "1â€ƒ2â†5â€ƒ(3â€ƒ4)â†6", carrierCount: 4, associatedCarrier: [1, 2, 3, 4, 4, 4], modulatedBy: [[], [5], [6], [6], [], []] },
    { name: "1â€ƒ2â€ƒ(3â€ƒ4â€ƒ5)â†6", carrierCount: 5, associatedCarrier: [1, 2, 3, 4, 5, 5], modulatedBy: [[], [], [6], [6], [6], []] },
    { name: "1â€ƒ2â€ƒ3â€ƒ(4â€ƒ5)â†6", carrierCount: 5, associatedCarrier: [1, 2, 3, 4, 5, 5], modulatedBy: [[], [], [], [6], [6], []] },
    { name: "1â€ƒ2â†4â€ƒ3â†(5â€ƒ6)", carrierCount: 3, associatedCarrier: [1, 2, 3, 3, 3, 3], modulatedBy: [[], [4], [5, 6], [], [], []] },
    { name: "1â†4â€ƒ2â†(5â€ƒ6)â€ƒ3", carrierCount: 3, associatedCarrier: [1, 2, 3, 3, 3, 3,], modulatedBy: [[4], [5, 6], [], [], [], []] },
    { name: "1â€ƒ2â€ƒ3â†5â€ƒ4â†6", carrierCount: 4, associatedCarrier: [1, 2, 3, 4, 4, 4], modulatedBy: [[], [], [5], [6], [], []] },
    { name: "1â€ƒ(2â€ƒ3)â†5â†6â€ƒ4", carrierCount: 4, associatedCarrier: [1, 2, 3, 4, 4, 4,], modulatedBy: [[], [5], [5], [], [6], []] },
    { name: "1â€ƒ2â€ƒ3â†5â†6â€ƒ4", carrierCount: 4, associatedCarrier: [1, 2, 3, 4, 4, 4], modulatedBy: [[], [], [5, 6], [], [], []] },
    { name: "(1â€ƒ2â€ƒ3â€ƒ4â€ƒ5)â†6", carrierCount: 5, associatedCarrier: [1, 2, 3, 4, 5, 5], modulatedBy: [[6], [6], [6], [6], [6], []] },
    { name: "1â€ƒ2â€ƒ3â€ƒ4â€ƒ5â†6", carrierCount: 5, associatedCarrier: [1, 2, 3, 4, 5, 5], modulatedBy: [[], [], [], [], [6], []] },
    { name: "1â€ƒ2â€ƒ3â€ƒ4â€ƒ5â€ƒ6", carrierCount: 6, associatedCarrier: [1, 2, 3, 4, 5, 6], modulatedBy: [[], [], [], [], [], []] },
]);
...
Config.operatorFrequencies = toNameMap([
    { name: "0.25Ã—", mult: 0.25, hzOffset: 0.0, amplitudeSign: 1.0 },
    { name: "0.5Ã—", mult: 0.5, hzOffset: 0.0, amplitudeSign: 1.0 },
    ...
    { name: "14Ã—", mult: 14.0, hzOffset: 0.0, amplitudeSign: 1.0 },
...
Config.feedbacks = toNameMap([
    ...
    { name: "5âŸ²", indices: [[], [], [], [], [5], []] },
    { name: "6âŸ²", indices: [[], [], [], [], [], [6]] },
    { name: "1âŸ² 2âŸ²", indices: [[1], [2], [], [], [], []] },
    { name: "2âŸ² 3âŸ²", indices: [[], [2], [3], [], [], []] },
    { name: "3âŸ² 4âŸ²", indices: [[], [], [3], [4], [], []] },
    { name: "4âŸ² 5âŸ²", indices: [[], [], [], [4], [5], []] },
    { name: "5âŸ² 6âŸ²", indices: [[], [], [], [], [5], [6]] },
    { name: "1âŸ² 6âŸ²", indices: [[1], [], [], [], [], [6]] },
    { name: "1âŸ² 3âŸ²", indices: [[1], [], [3], [], [], []] },
    { name: "1âŸ² 4âŸ²", indices: [[1], [], [], [4], [], []] },
    { name: "1âŸ² 5âŸ²", indices: [[1], [], [], [], [5], []] },
    { name: "4âŸ² 6âŸ²", indices: [[], [], [], [4], [], [6]] },
    { name: "2âŸ² 6âŸ²", indices: [[], [2], [], [], [], [6]] },
    { name: "3âŸ² 6âŸ²", indices: [[], [], [3], [], [], [6]] },
    { name: "1âŸ² 2âŸ² 3âŸ²", indices: [[1], [2], [3], [], [], []] },
    { name: "4âŸ² 5âŸ² 6âŸ²", indices: [[], [], [], [4], [5], [6]] },
    { name: "1âŸ² 3âŸ² 6âŸ²", indices: [[1], [], [3], [], [], [6]] },
    { name: "1âŸ² 2âŸ² 3âŸ² 4âŸ²", indices: [[1], [2], [3], [4], [], []] },
    { name: "1âŸ² 2âŸ² 3âŸ² 4âŸ² 5âŸ² 6âŸ²", indices: [[1], [2], [3], [4], [5], [6]] },
    { name: "1â†’2", indices: [[], [1], [], [], [], []] },
    { name: "1â†’3", indices: [[], [], [1], [], [], []] },
    { name: "1â†’4", indices: [[], [], [], [1], [], []] },
    { name: "2â†’4", indices: [[], [], [], [2], [], []] },
    ...
    { name: "4â†’6", indices: [[], [], [], [], [], [4]] },
    { name: "5â†’6", indices: [[], [], [], [], [], [5]] },
    { name: "1â†’3â†’4", indices: [[], [], [1], [], [3], []] },
    { name: "2â†’5â†’6", indices: [[], [], [], [], [2], [5]] },
    { name: "2â†’4â†’6", indices: [[], [], [], [2], [], [4]] },
    { name: "4â†’5â†’6", indices: [[], [], [], [], [4], [5]] },
    { name: "3â†’4â†’5â†’6", indices: [[], [], [], [3], [4], [5]] },
    { name: "2â†’3â†’4â†’5â†’6", indices: [[], [1], [2], [3], [4], [5]] },
    { name: "1â†’2â†’3â†’4â†’5â†’6", indices: [[], [1], [2], [3], [4], [5]] },
]);
...
EditorConfig.versionDisplayName = beepbox.Config.versionDisplayName;
EditorConfig.presetCategories = beepbox.toNameMap([
    {
        name: "Custom Instruments",
        presets: beepbox.toNameMap([
    ...
    },
    {
        ...
        presets: beepbox.toNameMap([
            ...
            { name: "FM organ", midiProgram: 16, settings: { "type": "FM", "effects": "reverb", "transition": "soft", "chord": "custom interval", "filterCutoffHz": 8000, "filterResonance": 0, "filterEnvelope": "steady", "vibrato": "delayed", "algorithm": "1â†3â€ƒ2â†4", "feedbackType": "1âŸ²â€ƒ2âŸ²", "feedbackAmplitude": 0, "feedbackEnvelope": "steady", "operators": [{ "frequency": "1Ã—", "amplitude": 7, "envelope": "custom" }, { "frequency": "2Ã—", "amplitude": 7, "envelope": "custom" }, { "frequency": "1Ã—", "amplitude": 11, "envelope": "steady" }, { "frequency": "2Ã—", "amplitude": 11, "envelope": "steady" }] } },
    ...
    },
    {
        ...
        presets: beepbox.toNameMap([
            ...
            { name: "electric piano 2", midiProgram: 5, generalMidi: true, settings: { "type": "FM", "effects": "reverb", "transition": "hard fade", "chord": "harmony", "filterCutoffHz": 2828, "filterResonance": 0, "filterEnvelope": "custom", "vibrato": "none", "algorithm": "1â†4â€ƒ2â†5â€ƒ3â†6", "feedbackType": "6âŸ²", "feedbackAmplitude": 5, "feedbackEnvelope": "decay 1", "operators": [{ "frequency": "1Ã—", "amplitude": 15, "envelope": "twang 3" }, { "frequency": "1Ã—", "amplitude": 15, "envelope": "decay 3" }, { "frequency": "~1Ã—", "amplitude": 11, "envelope": "custom" }, { "frequency": "14Ã—", "amplitude": 2, "envelope": "twang 1" }, { "frequency": "1Ã—", "amplitude": 5, "envelope": "custom" }, { "frequency": "~1Ã—", "amplitude": 5, "envelope": "decay 3" }] } },
    ...
    },
    {
        ...
        presets: beepbox.toNameMap([
            ...
            { name: "violin 2", midiProgram: 40, generalMidi: true, settings: { "type": "FM", "effects": "reverb", "transition": "cross fade", "chord": "harmony", "filterCutoffHz": 2828, "filterResonance": 43, "filterEnvelope": "steady", "vibrato": "light", "algorithm": "(1â€‚2)â†(3â€‚4)", "feedbackType": "4âŸ²", "feedbackAmplitude": 5, "feedbackEnvelope": "twang 3", "operators": [{ "frequency": "4Ã—", "amplitude": 15, "envelope": "custom" }, { "frequency": "3Ã—", "amplitude": 13, "envelope": "custom" }, { "frequency": "2Ã—", "amplitude": 7, "envelope": "steady" }, { "frequency": "7Ã—", "amplitude": 8, "envelope": "swell 1" }] } },
...
(function (ModSetting) {
    ...
    ModSetting[ModSetting["mstFMSlider5"] = 19] = "mstFMSlider5";
    ModSetting[ModSetting["mstFMSlider6"] = 20] = "mstFMSlider6";
